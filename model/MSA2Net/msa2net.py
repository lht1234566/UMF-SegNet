...
import sys
sys.path.append('/home/ubuntu/Luhaotian/Paper-pre/muti-model_fusion/code/myproject/model/compare_model/MSA2Net/')
...
class Msa2Net(nn.Module):
    def __init__(self, num_classes=1, token_mlp_mode="mix_skip"):
        ...
        # Encoder
        self.backbone = MaxViT4Out_Small(n_class=num_classes, img_size=256)
