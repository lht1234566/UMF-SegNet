...
from model.compare_model.TransUnet.vit_seg_modeling_resnet_skip import ResNetV2
...
class TransUNet(nn.Module):
    def __init__(self, config, img_size=224, num_classes=1, zero_head=False,
...
if __name__ == "__main__":
    ...
    config_vit.n_skip = 1
    config_vit.patches.grid = (int(2), int(2))

    model = TransUNet(config_vit,img_size=128, in_channels=3, dummy=False, num_classes=1)
