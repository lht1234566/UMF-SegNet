import torch
import sys
sys.path.append('/home/ubuntu/Luhaotian/Paper-pre/muti-model_fusion/code/myproject/model/compare_model/VPTTA/')
from resnet_TTA import resnet34, resnet50
...
if __name__ == "__main__":
    ...
    start = time.time()
    model = ResUnet(resnet='resnet34', num_classes=1, pretrained=False)
    # print(model.res)
    # model.cuda().eval()
